...
import {PoliceOfficerRoutingModule} from './police-officer-routing.module';
...
@NgModule({
  declarations: [
    PoliceOfficerComponent,
      ApprovePoliceOfficerComponent,
    //   ViewCustomerComponent,
      CreatePoliceOfficerComponent,
    LockedPoliceOfficerComponent],
  imports: [
    CommonModule,
    PoliceOfficerRoutingModule,
    DataTablesModule,
    UtilModule,
    MatFormFieldModule,
    MatInputModule,
